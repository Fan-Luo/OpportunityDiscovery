...
param_grids = [
    ...
    [{'random_state':[830],'hidden_layer_sizes':[(50,),(100,),(150,),(20,5,)],'early_stopping':[True], 'learning_rate': ['constant', 'adaptive'], 'learning_rate_init':[0.001,0.01,0.1,1], 'max_iter': [10000000], 'momentum': [0.1,0.5,0.9], 'solver':['sgd']}]
